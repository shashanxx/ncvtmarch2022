...
public partial class PayCash_PayOnline : System.Web.UI.Page
{
    ...
    protected void ddlCardType_SelectedIndexChanged(object sender, EventArgs e)
    {
        ...
        {
            if (ddlCardType.SelectedValue.ToString().ToLower() == "debit card" && TotalAmount <= 2000.0)
            {
                BankCharges = 0;
            ...
            {
                BankCharges = Convert.ToDouble(((TotalAmount * 2.0) / 100).ToString("##.00"));
