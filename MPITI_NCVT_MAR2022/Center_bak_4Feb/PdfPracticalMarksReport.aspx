<%@ Page Language="C#" AutoEventWireup="true" CodeFile="PdfPracticalMarksReport.aspx.cs" Inherits="Center_PdfPracticalMarksReport" %>
...
<body>
    ...
    <div class="element">
        <table style="width:100%; border:1px solid black;" align="center" cellpadding="0" cellspacing="0">
            <tr>
                <td style="width:2%;"></td>
                <td colspan="5" align="center" style="border-bottom:1px solid; border-left:1px solid; border-right:1px solid; font-weight:bold; font-size:20px; background-color:#E9B395">Practical Marks</td>   
                <td style="width:2%;"></td>
            </tr>
            <tr>
                <td></td>
                <td colspan="5" align="center" style="border-bottom:1px solid; border-left:1px solid; border-right:1px solid;font-size:14px;font-weight:bold;">NAME OF ITI : <asp:Label ID="lblITIName" runat="server" Text=""></asp:Label></td>
                <td></td>
            </tr>
            <tr>
                <td></td>
