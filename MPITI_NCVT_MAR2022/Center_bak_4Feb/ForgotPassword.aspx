                    ...
                    <table style="width: 100%; border: 1px solid black; font-family: Verdana;" cellpadding="0"
                        ...
                        <tr>
                            <td style="height: 20px;">
                               LoginId</td>
                            <td>
                                <asp:TextBox ID="txtloginid" runat="server" Text="" Width="299px" TextMode="Password" MaxLength="18"></asp:TextBox>
                            </td>
                            <td>
                            </td>
                        </tr>
                        ...
                        <tr>
                            ...
                            <td style="vertical-align:top;">
                                ...
                                <asp:Button ID="btnshowpass" runat="server" Text="Show Password" Style="width: 125px; border-radius: 5px;
