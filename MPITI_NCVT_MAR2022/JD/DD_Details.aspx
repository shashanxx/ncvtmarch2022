<%@ Page Language="C#" AutoEventWireup="true" CodeFile="DD_Details.aspx.cs" Inherits="Principle_Print" %>
        ...
        <div width="100%" style="margin-top: 20px;">
            ...
            <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" Width="100%" HeaderStyle-BackColor="#cc632a" OnRowDataBound="GridView1_RowDataBound">
                <Columns>
                    ...
                    <%--<asp:TemplateField HeaderText="Trade" ItemStyle-HorizontalAlign="Center">
                        <ItemTemplate>
                            <asp:TextBox ID="txtTrade" runat="server" Style="color: black; margin-left: 20px; border: none" Enabled="false" BackColor="#ffffff" Text='<%# Eval("Trade") %>' Width="50px"></asp:TextBox>
                        </ItemTemplate>
                        <ItemStyle HorizontalAlign="Center" Font-Names="Arial" Font-Size="13px"></ItemStyle>
                        <HeaderStyle Font-Names="Arial" Font-Size="15px" />
                    </asp:TemplateField>--%>
                    <%--<asp:TemplateField HeaderText="Semester" ItemStyle-HorizontalAlign="Center">
                        <ItemTemplate>
                            <asp:TextBox ID="txtSem" runat="server" Style="color: black; margin-left: 20px; border: none" Enabled="false" BackColor="#ffffff" Text='<%# Eval("Semester") %>' Width="50px"></asp:TextBox>
                        </ItemTemplate>
                        <ItemStyle HorizontalAlign="Center" Font-Names="Arial" Font-Size="13px"></ItemStyle>
                        <HeaderStyle Font-Names="Arial" Font-Size="15px" />
                    </asp:TemplateField>--%>
