   ...
   public void Fillgrid()
    {
      ...
      {
          ds = MySql.GetDataSetWithQuery("Exec getAdminJDReports @session= '" + session + "', @Semester='" + semester + "'");
      }
      else if(ddlEntryType.SelectedValue.ToString()=="Steno")
      {
          ds = MySql.GetDataSetWithQuery("Exec getAdminJDReports_Steno @session= '" + session + "', @Semester='" + semester + "'");
      }
      else
      {
