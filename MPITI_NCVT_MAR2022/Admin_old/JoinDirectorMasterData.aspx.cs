...
public partial class Admin_JoinDirectorMasterData : System.Web.UI.Page
{
    ...
    public void Fillgrid()
    {
        ...
        {
            ds = MySql.GetDataSetWithQuery("Exec getMasterJDReports @session= '" + session + "', @Semester='" + semester + "'");
        }
        else if (ddlEntryType.SelectedValue.ToString() == "Steno")
        {
            ds = MySql.GetDataSetWithQuery("Exec getMasterJDReports_steno @session= '" + session + "', @Semester='" + semester + "'");
        }
        else
        {
            lblCMessage.Text = "Select Entry Type";
    ...
    protected void btnprint_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            string attachment = "attachment; filename=JDMasterReports.xls";
    ...
    protected void GridView1_RowDataBound(object sender, GridViewRowEventArgs e)
    {
          if (e.Row.RowType == DataControlRowType.Header)
          {
              if (ddlEntryType.SelectedValue=="ED")
              {
                  e.Row.Cells[8].Text = "Engg. Drawing Marks";
              }
              else
              {
                  e.Row.Cells[8].Text = "Steno Practical Marks";
              }
          }
