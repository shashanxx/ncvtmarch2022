    ...
    <form id="form1" runat="server">
        ...
        <div width="100%" style="margin-top: 20px;">
            ...
            <div style="margin-top: 0px;">
                ...
                <asp:Button ID="btnProceedDD" runat="server" Text="Proceed to Payment DD Mode" Style="width: 230px; border-radius: 5px; background-color: #cc632a; color: white; font-weight: bold; height: 35px; margin-right: 10px;" OnClick="btnProceedDD_Click" Visible="false" OnClientClick="return ValidateControls();" />
