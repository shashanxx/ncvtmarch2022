            ...
            if (!IsPostBack)
            {
                ...
                if (Session["PaymentMode"].ToString() == "Online")
                {
                    ...
                    if (Auth_Status == "Success")
                    {
                        ...
                        CommonUtilities.LogFileWrite("Auth suuccess received:" + PID.ToString());
                        ...
                        int UpdateStatus = Mysql.UpdatePaymentStatus(Convert.ToInt32(Order_Id), Order_Id, "Yes", Session["PaymentMode"].ToString(), Trans_Code, Trans_Msg);
                        if (UpdateStatus == 1)
                        {
