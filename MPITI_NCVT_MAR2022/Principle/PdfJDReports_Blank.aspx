...
<body>
    <form id="form1" runat="server">
        <div class="element">
            ...
            <input id="btnPrint" runat="server" class="btnbx" name="btnPrint" onclick="PrintData()" style="width: 100px; font-weight: bold; background-color: #cc632a; color: white; border-radius: 10px; height: 40px;" type="submit" value="Print" />
