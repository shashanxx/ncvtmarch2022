<%@ Page Language="C#" AutoEventWireup="true" CodeFile="PaymentSummary.aspx.cs" Inherits="Principle_PaymentSummary" %>
    ...
    <form id="form1" runat="server">
        ...
        <div width="100%" style="margin-top: 20px;">
                ...
                <Columns>
                    ...
                    <asp:TemplateField HeaderText="Amount" ItemStyle-HorizontalAlign="Center">
                     ...
                     <asp:TemplateField HeaderText="Year" ItemStyle-HorizontalAlign="Center">
                        <ItemTemplate>
                            <asp:Label ID="lblAdmissionyear" runat="server" Text='<%# Eval("Year") %>'></asp:Label>
                        </ItemTemplate>
                        <ItemStyle HorizontalAlign="Center" Font-Names="Arial" Font-Size="13px"></ItemStyle>
                        <HeaderStyle Font-Names="Arial" Font-Size="15px" />
                    </asp:TemplateField>
            ...
            <div style="margin-top: 0px; margin-bottom:20px;">
                ...
                <asp:Button ID="btnProceed" runat="server" Text="Proceed to Payment Online Mode" Style="width: 230px; border-radius: 5px; background-color: #cc632a; color: white; font-weight: bold; height: 35px; margin-right: 10px;" OnClick="btnProceed_Click" Visible="false" OnClientClick="return ValidateControls();" />
                <asp:Button ID="btnProceedDD" runat="server" Text="Proceed to Payment DD Mode" Style="width: 230px; border-radius: 5px; background-color: #cc632a; color: white; font-weight: bold; height: 35px; margin-right: 10px;display:none;" OnClick="btnProceedDD_Click" Visible="true" OnClientClick="return ValidateControls();" />
