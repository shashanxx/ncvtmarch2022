...
public partial class Principle_AdmitCardStenoPrac : System.Web.UI.Page
{
    ...
    private void BindStudentDetails(int id)
    {
        ...
        dtgrid = Mysql.GetDataTableWithQuery("exec GetStudentDetailsForAdmitCard_StenoPrac @id=" + id + "");
    ...
    {
        Mysql.ExecuteNonQuery("InsertAdmitCardDownloadStatus_StenoPrac @ID=" + ID + "");
    }
}