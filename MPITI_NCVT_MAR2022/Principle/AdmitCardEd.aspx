<%@ Page Language="C#" AutoEventWireup="true" CodeFile="AdmitCardEd.aspx.cs" Inherits="Principle_AdmitCardEd" %>
        ...
        <div id="PrintDiv" style="width: 750px; margin: 0px auto; font-size: 18px; line-height: 18px; border: 4px solid #000; padding: 10px 20px 10px 20px;" class="hinditext">
            <div style="text-align: center;">
                ...
                <h3 style="margin: 0px; padding: 0px; font-family: ariel;">NCVT <asp:Label runat="server" ID="lblAnnualOrSemester" Text=""></asp:Label> Examination- 2020
                    <br />
                    <br />
                    (Admit Card for Engineering Drawing – Examination) Sept-2021
                </h3>
            </div>
            ...
            <table width="100%" border="1" cellspacing="0" cellpadding="0" style="margin: 3px 0px 0px 0px; background: url(watermark.png); background-repeat: no-repeat; background-position: center center;">
                <tbody>
                    <tr>
                        ...
                        <td style="padding: 2px 8px 10px 8px; width: 50%; font-family: ariel;"><strong>Trainee Name:-</strong>
                    ...
                    <tr>
                        <td style="padding: 2px 8px 20px 8px; font-family: ariel" colspan="2"><strong>Engineering Drawing Exam Centre:-</strong>
                    ...
                    <tr>
                        ...
                        <td style="padding: 2px 8px 2px 8px; font-family: ariel"><strong>Subject:-</strong>
                            <asp:Label ID="Label4" runat="server" Text="Engineering Drawing" CssClass="lblengfont" />
                            <asp:Label ID="Label5" runat="server" Text="" CssClass="lblengfont" /></td>
                    </tr>

                    <tr>
                        <%--<td style="padding: 2px 8px 2px 8px; font-family: ariel;"><strong>Date of Exam:-</strong>
                            <asp:Label ID="lblPaper1Date" runat="server" Text="27/Aug/2019" CssClass="lblengfont" /></td>--%>
                        <td style="padding: 2px 8px 2px 8px; font-family: ariel" colspan="2"><strong>Start Date and Time of Exam:-</strong>
                            <asp:Label ID="lblExamtime" runat="server" Text="" CssClass="lblengfont" />
            ...
            <p style="text-align: center; font-size: 24px; margin: 10px 8px -15px 0px;"><strong>-:<span style="background: #ffff00; font-family: ariel">Engineering Drawing Examination Instructions</span>:- </strong></p>
            <ol style="list-style: none; background: url(watermark.png); background-repeat: no-repeat; background-position: center center;">
                <li><span style="font-family: Arial, Helvetica, sans-serif; font-size: 14px; margin: 0px 8px 0px 0px; display: inline-block;">1.</span><span style="font-family: ariel">The Examination Centre address on this Admit Card might be changed. Please confirm with the principal of your institution at least 2 days before of the Engineering Drawing examination.</span></li>
                <li><span style="font-family: Arial, Helvetica, sans-serif; font-size: 14px; margin: 0px 8px 0px 0px; display: inline-block;">2.</span><span style="font-family: ariel">Please carry a valid photo identity card along with this Admit Card to the Engineering Drawing exam Centre.</span></li>
                <li><span style="font-family: Arial, Helvetica, sans-serif; font-size: 14px; margin: 0px 8px 0px 0px; display: inline-block;">3.</span><span style="font-family: ariel">Please ensure that you report to the Engineering Drawing exam center at least 30 minute prior to the start time.</span></li>
