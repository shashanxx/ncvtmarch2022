...
public partial class Principle_DownloadAdmitCard : System.Web.UI.Page
{
    ...
    protected void BindGrid()
    {
        ...
        dtgrid = Mysql.GetDataTableWithQuery("exec GetITICompositeReport_ForDownloadAdmitCard @AdmissionYear=" + ddlAdmissionYear.SelectedValue + ",@Semester=" + ddlSemester.SelectedValue + ", @ExamType='" + ddlexamtype.SelectedValue + "', @Trade=" + ddlTradeName.SelectedValue + ",@ITICode='" + Session["Username"].ToString() + "'");
    ...
    private void CreateITICompositeReportExcel(DataTable dt)
    {
        ...
        workSheet.Cells["A1:L1"].Style.Font.Size = 18;
        ...
        workSheet.Cells["A1:L1"].Style.Font.UnderLine = true;
        ...
        workSheet.Cells["A2:L2"].Style.Fill.PatternType = ExcelFillStyle.Solid;
        workSheet.Cells["A2:L2"].Style.Fill.BackgroundColor.SetColor(colFromHeximg);

        workSheet.Cells["A3:L3"].Merge = true;
        workSheet.Cells["A3:L3"].Style.Font.Bold = true;
        workSheet.Cells["A3:L3"].Style.Font.Size = 13;
        ...
        workSheet.Cells["A4:L5"].Style.Font.Bold = true;
        ...
        workSheet.Cells["A7:L7"].Style.Fill.PatternType = ExcelFillStyle.Solid;
        workSheet.Cells["A7:L7"].Style.Fill.BackgroundColor.SetColor(colFromHex);
        ...
        ExcelRange range = workSheet.Cells["A1:L" + lastcell + ""];
