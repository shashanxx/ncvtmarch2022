...
public partial class Student_StudentEntry : ClsErrorLog
{
    ...
    protected void BindDistrict()
    {
        ...
        DataSet dsdistrict = Mysql.GetDataSetWithQuery("exec GetDistrict  '" + ddlexamcity1.SelectedItem.Text + "','" + ddlexamcity2.SelectedItem.Text + "','" + ddlexamcity3.SelectedItem.Text + "'");
    ...
    {
        ddlzone.Items.Clear();
        DataSet dsZone = Mysql.GetDataSetWithQuery("exec GetZone  '" + ddlexamcity1.SelectedItem.Text + "','" + ddlexamcity2.SelectedItem.Text + "','" + ddlexamcity3.SelectedItem.Text + "','" + ddldistrict.SelectedItem.Text + "'");
    ...
    {
        string strstdName = Mysql.SingleCellResultInString("GetCandidateName @RollNumber='" + CID + "'");
    ...
    protected void ddlexamcity3_SelectedIndexChanged(object sender, EventArgs e)
    {
        BindDistrict();
    }
