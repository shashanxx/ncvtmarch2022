<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ActiveNDeactivatedMenus.aspx.cs" Inherits="Admin_ActiveNDeactivatedMenus" %>

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>Active And Deactivated Menus</title>
    <style type="text/css">
        @charset "utf-8";
        /* CSS Document */
    ...
    <form id="form1" runat="server">
        <table style="width: 100%; font-family: Arial; background-image: url('../images/back.jpg');"
            ...
            <tr style="background-color: #d8b377; height: 25px;">
                <td colspan="20" style="height: 25px; float: left;">Active And Deactivated Menus
                </td>
            </tr>
            <tr>
                <td>
                    <br />
                    <br />
                    <asp:GridView ID="gvData" runat="server" AutoGenerateColumns="False" DataKeyNames="ID" Width="750px"
                        OnRowDataBound="gvData_RowDataBound" OnRowEditing="gvData_RowEditing" OnRowCancelingEdit="gvData_RowCancelingEdit"
                        OnRowUpdating="gvData_RowUpdating" OnRowDeleting="gvData_RowDeleting" EmptyDataText="No records has been added." BackColor="#DEBA84" BorderColor="#DEBA84" BorderStyle="None" BorderWidth="1px" CellPadding="3" CellSpacing="2">
                        <Columns>
                            ...
                            <asp:TemplateField HeaderText="Status" ItemStyle-Width="150">
                                <ItemTemplate>
                                    <asp:CheckBox ID="chkStatus" Enabled="false" runat="server" Checked='<%# Convert.ToBoolean(Eval("IsActive")) %>'></asp:CheckBox>
                                </ItemTemplate>
                                <EditItemTemplate>
                                    <asp:CheckBox ID="ChckStatusEdit" runat="server" Checked='<%# Convert.ToBoolean(Eval("IsActive")) %>'></asp:CheckBox>
                                </EditItemTemplate>
