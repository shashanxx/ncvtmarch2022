...
public partial class Admin_AdminCompositeReport : System.Web.UI.Page
{
    ...
    private void BindTradeList()
    {
        ...
        dtTrade = Mysql.GetDataTableWithQuery("exec GetAllTradeList  @ExistsZone='" + ddlZone.SelectedValue.ToString() + "',@District='" + ddlDistrict.SelectedValue.ToString() + "',@ITICode='" + ddlITICode.SelectedValue.ToString() + "'");
    ...
    private void BindDivisionList()
    {
        ...
        {
            ddlZone.DataSource = dtDivision;
            ddlZone.DataTextField = "Division";
            ddlZone.DataValueField = "LcaseDivision";
            ddlZone.DataBind();
        }
    ...
    private void BindDistrictList()
    {
        ...
        dtDistrict = Mysql.GetDataTableWithQuery("exec GetDistList '" + ddlZone.SelectedValue.ToString() + "'");
    ...
    protected void ddlTTIType_SelectedIndexChanged(object sender, EventArgs e)
    {
        BindITICodeNameList();
    }

    private void BindITICodeNameList()
    {
        DataTable dtITICodeName = new DataTable();
        dtITICodeName = Mysql.GetDataTableWithQuery("exec GetITICodeName_New @ExistsZone='" + ddlZone.SelectedValue.ToString() + "',@District='" + ddlDistrict.SelectedValue.ToString() + "',@TTIType='" + ddlTTIType.SelectedValue.ToString() + "'");
    ...
    protected void BindGrid()
    {
        ...
        dtgrid = Mysql.GetDataTableWithQuery("exec GetAdminCompositeReport_New @AdmissionYear=" + ddlAdmissionYear.SelectedValue + ",@Semester=" + ddlSemester.SelectedValue + ", @ExamType='" + ddlexamtype.SelectedValue + "', @Trade=" + ddlTradeName.SelectedValue + ",@ITICode='" + ddlITICode.SelectedValue + "', @Division='" + ddlZone.SelectedValue + "', @District='" + ddlDistrict.SelectedValue + "',@TTIType='" + ddlTTIType.SelectedValue.ToString() + "'");
    ...
    private void CreateAdminCompositeReportExcel(DataTable dt)
    {
        ...
        var workSheet = excel.Workbook.Worksheets.Add("Admin Composite Report");
        ...
        workSheet.Cells["A1:O1"].Style.Font.Size = 18;
        workSheet.Cells[1, 1].Value = "Admin Composite Report";
        ...
        workSheet.Cells["A1:O1"].Style.Font.UnderLine = true;
        ...
        workSheet.Cells["A2:O2"].Style.Fill.PatternType = ExcelFillStyle.Solid;
        workSheet.Cells["A2:O2"].Style.Fill.BackgroundColor.SetColor(colFromHeximg);
        ...
        workSheet.Cells[3, 3].Value = "Zone :";
        workSheet.Cells[3, 4].Value = ddlZone.SelectedValue == "0" ? " " : ddlZone.SelectedItem.Text;
        workSheet.Cells[3, 5].Value = "District :";
        workSheet.Cells[3, 6].Value = ddlDistrict.SelectedValue == "0" ? " " : ddlDistrict.SelectedItem.Text;
        workSheet.Cells[3, 7].Value = "ITI :";
        workSheet.Cells[3, 8].Value = ddlITICode.SelectedValue == "0" ? " " : ddlITICode.SelectedItem.Text;
        workSheet.Cells[3, 9].Value = "Admission Year :";
        workSheet.Cells[3, 10].Value = ddlAdmissionYear.SelectedValue == "0" ? " " : ddlAdmissionYear.SelectedItem.Text;
        workSheet.Cells[4, 3].Value = "Trade Name :";
        workSheet.Cells[4, 4].Value = ddlTradeName.SelectedValue == "0" ? " " : ddlTradeName.SelectedItem.Text;
        if (int.Parse( ddlAdmissionYear.SelectedValue.ToString()) >= 2018)
        {
            workSheet.Cells[4, 5].Value = "Year :";
        }
        else
        {
            workSheet.Cells[4, 5].Value = "Semester :";
        }
        
        workSheet.Cells[4, 6].Value = ddlSemester.SelectedValue == "0" ? " " : ddlSemester.SelectedItem.Text;
        workSheet.Cells[4, 7].Value = "Exam Type :";
        workSheet.Cells[4, 8].Value = ddlexamtype.SelectedValue == "0" ? " " : ddlexamtype.SelectedItem.Text;
        workSheet.Cells["A3:O4"].Style.Font.Bold = true;
        //dt.Columns.Remove("ITICode");
        //dt.Columns.Remove("ITIName");
        for (var col = 1; col <= totalCols; col++)
        {
            workSheet.Cells[6, col].Value = dt.Columns[col - 1].ColumnName;
            workSheet.Cells[6, col].Style.Font.Bold = true;
        }
        System.Drawing.Color colFromHex = System.Drawing.ColorTranslator.FromHtml("#CC632A");
        workSheet.Cells["A6:O6"].Style.Fill.PatternType = ExcelFillStyle.Solid;
        workSheet.Cells["A6:O6"].Style.Fill.BackgroundColor.SetColor(colFromHex);
        ...
        ExcelRange range = workSheet.Cells["A1:O" + lastcell + ""];
        ...
        using (var memoryStream = new MemoryStream())
        {
            ...
            Response.AddHeader("content-disposition", "attachment;  filename=Admin Composite Report.xlsx");
    ...
    private void CreateAdminCompositeReportPdf(DataTable dt)
    {
        using (StringWriter sw = new StringWriter())
        {
            using (HtmlTextWriter hw = new HtmlTextWriter(sw))
            {
                ...
                sb.Append("<tr><td align='center' colspan = '5' style='font-size:18px; text-decoration:underline;'><b>Admin Composite Report</b></td></tr>");
                ...
                sb.Append(ddlZone.SelectedValue == "0" ? " " : ddlZone.SelectedItem.Text);
                sb.Append("</td><td></td><td align = 'right'><b>District : </b></td><td>");
                sb.Append(ddlDistrict.SelectedValue == "0" ? " " : ddlDistrict.SelectedItem.Text);
                sb.Append(" </td></tr>");
                sb.Append("<tr style='font-size:11px; font-family: Arial;'><td><b>ITI :</b></td><td>");
                sb.Append(ddlITICode.SelectedValue == "0" ? " " : ddlITICode.SelectedItem.Text);
                sb.Append("</td><td></td><td align = 'right'><b>Admission Year : </b></td><td>");
                sb.Append(ddlAdmissionYear.SelectedValue == "0" ? " " : ddlAdmissionYear.SelectedItem.Text);
                sb.Append(" </td></tr>");
                sb.Append("<tr style='font-size:11px; font-family: Arial;'><td><b>Trade Name :</b></td><td>");
                sb.Append(ddlTradeName.SelectedValue == "0" ? " " : ddlTradeName.SelectedItem.Text);
                if( int.Parse( ddlAdmissionYear.SelectedValue.ToString()) >= 2018)
                {
                    sb.Append("</td><td></td><td align = 'right'><b>Year : </b></td><td>");
                }
                else
                {
                    sb.Append("</td><td></td><td align = 'right'><b>Semester : </b></td><td>");
                }
                
                sb.Append(ddlSemester.SelectedValue == "0" ? " " : ddlSemester.SelectedItem.Text);
                sb.Append(" </td></tr>");
                sb.Append("<tr style='font-size:11px; font-family: Arial;'><td><b>Exam Type :</b></td><td>");
                sb.Append(ddlexamtype.SelectedValue == "0" ? " " : ddlexamtype.SelectedItem.Text);
                sb.Append("</td><td></td><td align = 'right'></td><td>");
                sb.Append(" </td></tr>");
                sb.Append("</table>");
                sb.Append("<br />");
                ...
                Response.AddHeader("content-disposition", "attachment;filename=Admin Composite Report.pdf");
    ...
    protected void ddlAdmissionYear_SelectedIndexChanged(object sender, EventArgs e)
    {
      if ( int.Parse(   ddlAdmissionYear.SelectedValue.ToString() ) >=2018)
      {
          ...
          ddlSemester.Items.Add(new ListItem("1","2"));
          ddlSemester.Items.Add(new ListItem("2", "4"));
      }
      else
      {
