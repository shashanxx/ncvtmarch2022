<%@ Page Title="" Language="C#" AutoEventWireup="true" CodeFile="PayOffline.aspx.cs" Inherits="PayCash_PayOnline" %>
...
<body style="font-family: Arial; font-size: 16px;">
    <form id="nonseamless" runat="server">
        ...
        <div width="100%" style="margin-top: 20px;">
            <table style="width: 100%; border: 1px solid grey; font-size: 14px; border-radius: 8px;" cellpadding="10" cellspacing="0">
                <tr>
                    ...
                    <td style="width: 20%; text-align: left; font-weight:bold;display:none;">ORDER NO.</td>
                    <td style="width: 50%; float:left;"><asp:Label ID="lblordernoTextvalue" runat="server" Style="font-weight: 700;display:none;"></asp:Label></td>
                </tr>
                
                <tr>
                    <td style="width: 30%;"></td>
                    <td style="width: 20%; text-align: left; font-weight:bold;">ACTUAL FEE</td>
                    <td style="width: 50%;"> <asp:TextBox ID="txtActualFeeValue" runat="server" MaxLength="50" CssClass="form-control " placeholder="ACTUAL FEE" ></asp:TextBox> <asp:Label ID="lblActualFeeValue" runat="server" Style="font-weight: 700"></asp:Label></td>
                </tr>
                <tr>
                    <td style="width: 30%;"></td>
                    <td style="width: 20%; text-align: left; font-weight:bold;"><span style="color: red;">*&nbsp;</span>CHOOSE CARD TYPE</td>
                    <td style="width: 50%; float:left;"><asp:DropDownList ID="ddlCardType" runat="server" Width="200px" CssClass="ddlstyle" AutoPostBack="true" OnSelectedIndexChanged="ddlCardType_SelectedIndexChanged">
                ...
                <tr>
                    ...
                    <td style="width: 50%;"><asp:Label ID="lblBankChargesValue" runat="server" Style="font-weight: 700"></asp:Label></td>
                </tr>
                <tr>
                    <td style="width: 30%;"></td>
                    <td style="width: 20%; text-align: left; font-weight:bold;">TOTAL</td>
                    <td style="width: 50%;"><asp:Label ID="lblamountvalue" runat="server" Style="font-weight: 700"></asp:Label></td>
                </tr>
                <tr>
                    <td colspan="3">
