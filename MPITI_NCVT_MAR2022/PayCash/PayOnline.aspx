        ...
        <div width="100%" style="margin-top: 20px;">
            <table style="width: 100%; border: 1px solid grey; font-size: 14px; border-radius: 8px;" cellpadding="10" cellspacing="0">
                <tr>
                    ...
                    <td style="width: 50%; float:left;"><asp:Label ID="lblordernoTextvalue" runat="server" Style="font-weight: 700"></asp:Label></td>
                </tr>
                ...
                <tr>
                    ...
                    <td style="width: 50%;"><asp:Label ID="lblActualFeeValue" runat="server" Style="font-weight: 700"></asp:Label>&nbsp;&nbsp<span style="color:blue">+ Bank charges applicable *</span></td>
                </tr>
                <tr style="display:none;">
                    <td style="width: 30%;"></td>
