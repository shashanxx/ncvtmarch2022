...
public partial class BillPay_Response : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        if (!Page.IsPostBack)
        {
            ...
            if (Auth_Status == "Success")
            {
                ...
                respmsg.ForeColor = System.Drawing.Color.Green;
            ...
            else if (Auth_Status == "Failure")
            {
                btnProceed.Visible = true;
                respcd.Text = "1";
                respmsg.Text = "Thank you for transacting with MPITI <br>However,the transaction has been declined.";
    ...
    {
        Response.Redirect("../Principle/OfflinePaymentList.aspx", false);
    }
    protected void btnPlzTry_Click(object sender, EventArgs e)
    {
        Response.Redirect("PayOffline.aspx?Username=" + Convert.ToString(Session["Username"]) + "");
    }
}
