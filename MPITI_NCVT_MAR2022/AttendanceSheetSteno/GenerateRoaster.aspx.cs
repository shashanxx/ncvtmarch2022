...
public partial class SchedulerSep2014_GenerateRoaster : System.Web.UI.Page
{
    ...
    protected void CenterList()
    {
        ...
        DsCenterlist = MySql.GetDataSetWithQuery("select [CentreName]+'|'+ convert(varchar(250),CentreCode) as CollegeName,CentreCode as CenterId from Centermaster_StenoPrac1 where CentreCode='" + Session["CentreCode"] + "'");
