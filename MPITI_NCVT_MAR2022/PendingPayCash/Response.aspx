...
<body style="margin: 0 0 0 0;">
    <form id="form1" runat="server">
                        ...
                        <form role="form">
                                ...
                                <div class="panel-body">
                                    ...
                                    <div class="row">
                                        <table class="registration-cont-Payment" align="center" border="0" cellpadding="0"
                                            cellspacing="0" style="font-size: 12px; color: black; background-attachment: scroll; background-image: url(../App_Themes/Images/pagebg1.gif); width: 100%; background-repeat: repeat; font-family: Verdana">
                                            ...
                                            <tr>
                                                <td style="padding-left: 17px;">
                                                    <table cellspacing="1" cellpadding="4" class="registration-cont-PayIndex"
                                                        ...
                                                        <tr>
                                                            <td width="40%" align="left" class="style5"></td>
                                                            <td width="50%" align="left" class="style5"></td>
                                                        </tr>
                                                        <tr>
                            ...
                            <asp:Label ID="respid" runat="server"></asp:Label></td>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td width="50%" align="left" valign="top">:<asp:Label ID="lblInfo" runat="server"></asp:Label>&nbsp;<br />
                                                                &nbsp;<asp:Label ID="respmsg" runat="server"></asp:Label></td>
                                                        </tr>
                                                        <tr>
                                                            <td valign="top" width="40%" align="left" class="style4"></td>
                                                            <td width="60%" align="left" valign="top" class="style4"></td>
                                                        </tr>
                                                    </table>
                                                </td>
                                            </tr>
        ...
        <div class="navbar navbar-default navbar-default" style="display: none;">
            <div class="container">
    ...
    <a href="#" class="navbar-btn btn pull-right">Contact us</a>-->
            </div>
        </div>
